...
public class CoreSimpleSpaceMachineMetaTileEntity extends WorkableTieredMetaTileEntity
    ...
    public CoreSimpleSpaceMachineMetaTileEntity(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap,
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new CoreSimpleSpaceMachineMetaTileEntity(metaTileEntityId, workable.getRecipeMap(), renderer, getTier(),
