 ...
 */
public class SimpleSpaceMachineMetaTileEntityResizable extends SimpleSpaceMachineMetaTileEntity {
     ...
     *                     RecipeMap.
     */
    public SimpleSpaceMachineMetaTileEntityResizable(ResourceLocation metaTileEntityId,
                                                RecipeMap<?> recipeMap,
                                                int inputAmount,
                                                int outputAmount,
