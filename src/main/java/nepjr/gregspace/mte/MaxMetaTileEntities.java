...
public class MaxMetaTileEntities {
    ...
    public static final MetaTileEntityRotorHolder[] ROTOR_HOLDER = new MetaTileEntityRotorHolder[GTValues.V.length];
    ...
    public static void init()
    {
        ...
        ROTOR_HOLDER[9] = registerMetaTileEntity(4000,
                new MetaTileEntityRotorHolder(gregtechId("rotor_holder.uhv"), GTValues.UHV));

        ROTOR_HOLDER[10] = registerMetaTileEntity(4001,
                new MetaTileEntityRotorHolder(gregtechId("rotor_holder.uev"), GTValues.UEV));

        ROTOR_HOLDER[11] = registerMetaTileEntity(4002,
                new MetaTileEntityRotorHolder(gregtechId("rotor_holder.uiv"), GTValues.UIV));

        ROTOR_HOLDER[12] = registerMetaTileEntity(4003,
                new MetaTileEntityRotorHolder(gregtechId("rotor_holder.uxv"), GTValues.UXV));

        ROTOR_HOLDER[13] = registerMetaTileEntity(4004,
                new MetaTileEntityRotorHolder(gregtechId("rotor_holder.opv"), GTValues.OpV));

        ROTOR_HOLDER[14] = registerMetaTileEntity(4005,
                new MetaTileEntityRotorHolder(gregtechId("rotor_holder.max"), GTValues.MAX));
    }
