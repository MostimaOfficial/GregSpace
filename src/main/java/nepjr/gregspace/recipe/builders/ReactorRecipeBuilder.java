...
public class ReactorRecipeBuilder extends RecipeBuilder<ReactorRecipeBuilder> {
    ...
    public ReactorRecipeBuilder() {}

    public ReactorRecipeBuilder(Recipe recipe, RecipeMap<ReactorRecipeBuilder> recipeMap) {
        super(recipe, recipeMap);
    }

    public ReactorRecipeBuilder(ReactorRecipeBuilder recipeBuilder) {
        super(recipeBuilder);
    }

    @Override
    public ReactorRecipeBuilder copy() {
        return new ReactorRecipeBuilder(this);
    }
    ...
    public ReactorRecipeBuilder blastFurnaceTemp(int blastFurnaceTemp) {
